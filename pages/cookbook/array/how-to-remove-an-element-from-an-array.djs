...
<div class="page-content">
    ...
    <p>
        فرض کنید که آرایه از آیتم ها در جاوااسکریپت داریم و می خواهیم یک آیتم مشخص (Avocado) را از آرایه حذف کنیم. برای انجام این کار چه روش هایی وجود دارد؟
    </p>
...
console.log(array); // ['Apple', 'Banana', 'Blackberry', 'Orange'] 
    ...
    <ol>
        ...
        <li>برای حذف آیتم Avocado کافیه تابع تست برای همه آیتم ها بجز این آیتم مقدار true رو برگردونه</li>
    </ol>
    <pre>
        <code class="language-javascript">
var array = ['Apple', 'Banana', 'Avocado', 'Blackberry', 'Orange']
...
console.log(filteredArray); // ['Apple', 'Banana', 'Blackberry', 'Orange'] 
    ...
    <p>
        <strong>توجه</strong>: این روش، مشکل روش قبل در مورد حذف تمامی تکرارهای یک آیتم رو نداره، چون تابع تست برای تمامی آیتم های آرایه فراخوانی میشه.
    </p>
    <p>
